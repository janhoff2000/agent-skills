...
This repository contains a collection of specialized skills designed to enhance the capabilities of AI coding assistants. Each skill provides a set of instructions, patterns, and best practices for specific domains.

## Directory Structure
Each directory represents a specific skill and contains a `SKILL.md` file with detailed instructions and metadata.

## Included Skills
- **ai-wrapper-product**: Expert guidance for building AI-wrapped products and SaaS.
